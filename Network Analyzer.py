...
def banner():
    result = pyfiglet.figlet_format("Harsha' Network Analyzer", font = "slant" ) #pyfiglet module helps create the art
    print(result)
...
def graph_data(data_file):
    ...
    if(sub2_option2==1):
        ...
        if(graph_option==1):
            ...
            dirname = os.path.dirname(file) #Stores directory path in 'dirname'
...
def about():
    ...
    print("This is developed solely for use in Windows OS and developmenT is underway for Linux distros as well.\n")
    print("Created By: BOMMANA HARSHAVARDHAN")
    print("GitHub: https://github.com/BommanaHarshavardhan04")
    print("LinkedIn: https://in.linkedin.com/in/bommana-harshavardhan")
    os.system('pause')
    os.system('cls')
    start_screen()
